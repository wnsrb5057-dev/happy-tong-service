...
function RoleBlocked({ navigate }) {
  return (
    <EmptyState
      title="?ëÍ∑º Í∂åÌïú???ÜÏäµ?àÎã§"
      description="?ÑÏû¨ Î°úÍ∑∏?∏Ìïú Í∂åÌïú??ÎßûÎäî ?îÎ©¥?ºÎ°ú ?¥Îèô?¥Ï£º?∏Ïöî."
    >
      <Button onClick={navigate}>?¥Îèô?òÍ∏∞</Button>
    </EmptyState>
  );
}
...
function NotFound({ navigate }) {
  return (
    <div className="center-panel">
      <EmptyState title="?îÎ©¥??Ï∞æÏùÑ ???ÜÏäµ?àÎã§" description="?îÏ≤≠??Í≤ΩÎ°úÎ•??§Ïãú ?ïÏù∏?¥Ï£º?∏Ïöî." />
      <Button onClick={navigate}>Í∏∞Î≥∏ ?îÎ©¥?ºÎ°ú ?¥Îèô</Button>
      <Analytics />
    </div>
  );
}
